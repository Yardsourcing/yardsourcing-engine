...
RSpec.describe 'Host Bookings by Status API' do
  before :each do
  ...
  describe 'happy path' do
    ...
    it 'returns 2 bookings with rejected status' do
      get "/api/v1/hosts/1/bookings?status=rejected"
    ...
    it 'returns 2 bookings with pending approved' do
      get "/api/v1/hosts/1/bookings?status=approved"
  ...
  describe 'sad path' do
    it 'returns an empty array if no bookings exist' do
      yard = create(:yard, host_id: 2)

      get "/api/v1/hosts/3/bookings?status=pending"
    ...
    it 'errors out when param is passed with nothing' do
      get "/api/v1/hosts/1/bookings?status="
